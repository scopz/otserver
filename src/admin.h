...
private:
	...
	bool actionEncryptConnection(uint8_t recvbyte, OutputMessagePool* outputPool, OutputMessage_ptr output);
	bool actionLogIn(uint8_t recvbyte, OutputMessagePool* outputPool, OutputMessage_ptr output);
	bool actionLoggedIn(uint8_t recvbyte, OutputMessagePool* outputPool, OutputMessage_ptr output);
};
