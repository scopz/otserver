...
spellSellModule.condition = function(cid) return isKnight(cid) or isPaladin(cid) end
spellSellModule.conditionFailText = "Sorry, I only teach spells to knights and paladins."
