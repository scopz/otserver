...
shopModule:addSellableItem({'pierce ring'}, 2207, 100)
shopModule:addSellableItem({'slash ring'}, 2208, 100)
shopModule:addSellableItem({'strike ring'}, 2209, 100)
...
shopModule:addBuyableItem({'pierce ring'}, 2207, 500)
shopModule:addBuyableItem({'slash ring'}, 2208, 500)
shopModule:addBuyableItem({'strike ring'}, 2209, 500)
...
keywordHandler:addKeyword({'ring'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "I'm selling and buying stealth rings, power rings, pierce rings, slash rings, and strike rings."})
