...
shopModule:addSellableItem({'thrust ring'}, 2207, 100)
shopModule:addSellableItem({'slash ring'}, 2208, 100)
shopModule:addSellableItem({'bash ring'}, 2209, 100)
...
shopModule:addBuyableItem({'thrust ring'}, 2207, 500)
shopModule:addBuyableItem({'slash ring'}, 2208, 500)
shopModule:addBuyableItem({'bash ring'}, 2209, 500)
...
keywordHandler:addKeyword({'ring'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "I'm selling and buying stealth rings, power rings, thrust rings, slash rings, and bash rings."})
