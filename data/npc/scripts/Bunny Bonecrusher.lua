...
function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, 'job') and npcHandler:hasFocus(cid) then
		if getPlayerSex(cid) == 1 then
			npcHandler:playerSay(cid, "I am the general of the queen's army and have not the time to explain this concept to you.", 1)
		else
			npcHandler:playerSay(cid, "I am the general of the queen's army! You really should consider to join, sister.", 1)
		end
		cidData.state = 0

	elseif msgcontains(msg, 'quest') and npcHandler:hasFocus(cid) or msgcontains(msg, 'mission') and npcHandler:hasFocus(cid) then
		if getPlayerSex(cid) == 1 then
			npcHandler:playerSay(cid, "Yeah. Entrusting a male with an important quest. Get serious!", 1)
		else
			npcHandler:playerSay(cid, "Sometimes the queen calls for heroines. Keep eyes and ears open!", 1)
		end
		cidData.state = 0
	...
	elseif cidData.state == 2 and msgcontains(msg, 'yes') and npcHandler:hasFocus(cid) then
	...
	elseif cidData.state == 2 and msgcontains(msg, '') and npcHandler:hasFocus(cid) then
