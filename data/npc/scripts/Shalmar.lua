...
spellSellModule.condition = function(cid) return isSorcerer(cid) or isDruid(cid) end
spellSellModule.conditionFailText = "Sorry, I only teach sorcerers and druids!"
...
keywordHandler:addKeyword({'rune'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "I don't sell this anymore, it sort of kept on confusing me to do that much work. Please talk to my assistant Asima in the next room to purchase magic goods."})
