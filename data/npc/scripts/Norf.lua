...
function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, 'spiritual') or msgcontains(msg, 'shielding') then
		npcHandler:playerSay(cid, "Here in the whiteflower temple you may receive the blessing of spiritual shielding. But we must ask of you to sacrifice 10.000 gold. Are you still interested?", 1)
		cidData.state = 1394
	...
	elseif cidData.state == 1394 and msgcontains(msg, 'yes') then
		if doPlayerRemoveMoney(cid, 10000) == true then
			if doPlayerAddBless(cid, 1) == true then
				npcHandler:playerSay(cid, "So receive the shielding of your spirit, pilgrim.", 1)
