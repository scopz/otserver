...
function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "mission") or msgcontains(msg, "pass") or msgcontains(msg, "quest") then
		...
		elseif getPlayerStorageValue(cid,8177) <= 99 then
			npcHandler:playerSay(cid, "You're supposed to kill green djinns, and still here you are..", 1)
			cidData.state = 0
		...
		if getPlayerStorageValue(cid,8094) >= 1 and getPlayerStorageValue(cid,8178) == 1 then
			if getPlayerStorageValue(cid,8165) >= 1 then
				if getPlayerStorageValue(cid,8147) >= 1 then
					npcHandler:playerSay(cid, "On the top floor of the green djinn fortress is a chest or a box, steal what's inside it and bring it to me! see you in a bit!", 1)
	...
	elseif cidData.state == 601 and msgcontains(msg, "yes") then
		...
		npcHandler:playerSay(cid, "You're welcome as a guest in our fortess, go and kill some green djinns when ever you want!", 5)
