...
function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, 'heal') then
		...
		elseif getCreatureHealth(cid) < 40 then
			...
			npcHandler:playerSay(cid, 'You aren\'t looking that bad. Sorry, I can\'t help you. If you are looking for additional protection, you should go on the pilgrimageof ashes.')
		end
		return true
	end
end
