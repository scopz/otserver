...
INSERT INTO `players` (`id`, `name`, `account_id`, `group_id`, `sex`, `vocation`, `experience`, `level`, `health`, `mana`, `manaspent`, `direction`, `lookbody`, `lookfeet`, `lookhead`, `looklegs`, `looktype`, `posx`, `posy`, `posz`, `lastlogin`, `lastlogout`, `lastip`, `save`, `conditions`, `skull_type`, `skull_time`, `loss_experience`, `loss_mana`, `loss_skills`, `loss_items`, `loss_containers`, `town_id`, `balance`, `online`, `rank_id`, `guildnick`) VALUES
(1, 'GM Legacy', 123456, 5, 1, 0, 100, 2, 185, 35, 1130, 2, 68, 76, 78, 58, 75, 32874, 31952, 11, 1467754551, 1467754550, 16777343, 1, 0x010001000002000000000338020c001b001c0000000010d7000000110a00000012102700001374850100fe0110000000020000000003b03600001b001c000000000b3e0200000c3333333f0d000060c20e3333333f0f000060c2fe, 0, 0, 100, 100, 100, 10, 100, 5, 0, 0, 0, '');
...
CREATE TRIGGER `oncreate_players` AFTER INSERT ON `players`
 FOR EACH ROW BEGIN
	INSERT INTO `player_skills` (`player_id`, `skillid`) VALUES (NEW.`id`, 0);
	INSERT INTO `player_skills` (`player_id`, `skillid`) VALUES (NEW.`id`, 1);
	INSERT INTO `player_skills` (`player_id`, `skillid`) VALUES (NEW.`id`, 2);
	INSERT INTO `player_skills` (`player_id`, `skillid`) VALUES (NEW.`id`, 3);
	INSERT INTO `player_skills` (`player_id`, `skillid`) VALUES (NEW.`id`, 4);
	INSERT INTO `player_skills` (`player_id`, `skillid`) VALUES (NEW.`id`, 5);
	INSERT INTO `player_skills` (`player_id`, `skillid`) VALUES (NEW.`id`, 6);
END
//
DELIMITER ;
...
INSERT INTO `player_skills` (`player_id`, `skillid`, `count`) VALUES
(1, 0, 0),
(1, 1, 0),
(1, 2, 0),
(1, 3, 0),
